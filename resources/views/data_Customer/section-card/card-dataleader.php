    ...
    <div class="p-1">
        ...
        <div class="scroll-slide bg-light" >
            <div class="d-flex p-2" >
                <div  onclick="getBranchAll(10)" class="btnBranch btn border border-light bg-warm-green-2 px-4 text-nowrap m-1 rounded-pill"><i class="fa-solid fa-border-all"></i> รายการติดตามวันนี้</div>
