          ...
          footerCallback: function (row, data, start, end, display) {
              ...
              console.log(arr2)
                    ...
                    total3 = ( arr2[1] / arr2[0] ) * 100
                      $(api.column(3).footer()).html( total3.toFixed(2) ).addClass('text-center');

                    total6 = ( arr2[3] / arr2[2] ) * 100
                    $(api.column(6).footer()).html( total6.toFixed(2) ).addClass('text-center');

                    total9 = ( arr2[5] / arr2[4] ) * 100
                    $(api.column(9).footer()).html( total9.toFixed(2) ).addClass('text-center');

                    total12 = ( arr2[7] / arr2[6] ) * 100
                    $(api.column(12).footer()).html( total12.toFixed(2) ).addClass('text-center');

                    total15 = ( arr2[9] / arr2[8] ) * 100
                    $(api.column(15).footer()).html( total15.toFixed(2) ).addClass('text-center');
